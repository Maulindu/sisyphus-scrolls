...
export default function SkyLayer({ scrollYProgress }) {
  const dawnOpacity = useTransform(scrollYProgress, [0, 0.12, 0.18], [1, 0.8, 0]);
  const morningOpacity = useTransform(scrollYProgress, [0.10, 0.20, 0.30], [0, 1, 0.5]);
  const noonOpacity = useTransform(scrollYProgress, [0.25, 0.35, 0.45], [0, 1, 0.5]);
  const afternoonOpacity = useTransform(scrollYProgress, [0.40, 0.50, 0.60], [0, 1, 0.5]);
  const duskOpacity = useTransform(scrollYProgress, [0.55, 0.65, 0.75], [0, 1, 0.5]);
  const twilightOpacity = useTransform(scrollYProgress, [0.70, 0.78, 0.88], [0, 1, 0.6]);
  const nightOpacity = useTransform(scrollYProgress, [0.82, 0.90, 1], [0, 1, 1]);
